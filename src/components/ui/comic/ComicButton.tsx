...
const base =
  "pressable inline-flex min-h-11 items-center justify-center border-2 border-panel-border px-4 py-3 font-display text-xs font-black uppercase tracking-widest transition-colors hover:border-web-strong focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-web";
